      ...
      <Center w="full" maxW="984px" mx="auto">
        <Stack w="100%" align="center">
          <Box w="705px" textAlign={'center'} color="#000">
            <Text fontFamily="Syne" fontSize="36px" fontStyle="normal" fontWeight="600">
          ...
          <Stack align="center" w="95%" my="60px" mx="auto">
            <CustomAccordion
              bg="#FFFFFF"
              h="fit-content"
            ...
            >
              <Stack spacing={4} px={4} py={4}>
                ...
                <Text
                  ...
                  data-aos-easing="ease-in-sine"
                >
                  <span style={{marginRight: '5px'}}>2.</span> {`Clear Channel Purpose: Ensure each
                ...
                <Text
                  ...
                  data-aos-easing="ease-in-sine"
                >
                  <span style={{marginRight: '5px'}}>4.</span> Set Up New {`Channels Effectively: When
          ...
          <Text>
            ...
            <span style={{color: '#4545FE', cursor: 'pointer'}}>contact support</span>{' '}
          </Text>
        </Stack>
      </Center>
    </Box>
