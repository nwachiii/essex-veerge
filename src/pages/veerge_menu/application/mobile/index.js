...
import TerraTrove from '/src/images/create-mobile-app/Terratrove.svg';
import Wonderland_Walls from '/src/images/create-mobile-app/Wonderland Walls.svg';
import Cosmo_Castles from '/src/images/create-mobile-app/Cosmo Castles.svg';
import Quaint_Quarters from '/src/images/create-mobile-app/Quaint Quarters.svg';
import Plot_Perfection from '/src/images/create-mobile-app/Plot Perfection.svg';
import Elysium from '/src/images/create-mobile-app/Elysium.svg';
import Luxuria_Lanes from '/src/images/create-mobile-app/Luxuria Lanes.svg';
import Urban_Sanctuary from '/src/images/create-mobile-app/Urban Sanctuary.svg';
...
export default function CreateMobileApplicationPage() {
  ...
  const themes = [
    {name: 'TerraTrove', image_src: TerraTrove.src, price: 7000, payment_plan: false},
    {
      name: 'Wonderland Walls',
      image_src: Wonderland_Walls.src,
      price: 7000,
      payment_plan: false,
    },
    {
      name: 'Cosmo Castles',
      image_src: Cosmo_Castles.src,
      price: 8000,
      payment_plan: false,
    },
    {
      name: 'Quaint Quarters',
      image_src: Quaint_Quarters.src,
      price: 6000,
      payment_plan: false,
    },
    {
      name: 'Plot Perfection',
      image_src: Plot_Perfection.src,
      price: 5000,
      payment_plan: false,
    },
    {name: 'Elysium', image_src: Elysium.src, price: 6000, payment_plan: false},
    {
      name: 'Luxuria Lanes',
      image_src: Luxuria_Lanes.src,
      price: 6000,
      payment_plan: false,
    },
    {
      name: 'Urban Sanctuary',
      image_src: Urban_Sanctuary.src,
      price: 6000,
      payment_plan: false,
    },
  ];
  ...
  const manage_scroll = () => {
    ...
    if (Math.min(scroll_percentage) >= 0 && Math.min(scroll_percentage < page_sections.length)) {
  ...
  return (
    <>
      ...
      >
        ...
        >
          ...
          >
            ...
            <Text
              ...
              lineHeight={'30px'}
            >
              Empower your homebuyers with unmatched flexibility through our mobile application,
              designed to seamlessly navigate the entire journey of a homebuyer, from initial
              exploration to final purchase.
            </Text>
        ...
        <Flex justifyContent={'center'} gap={'157px'}>
          <VStack alignItems={'flex-start'}>
            ...
            {page_sections.map((section, i) => (
              <MobileAppPageSection
                data={section}
                key={i}
                get_section={() => set_current_slide(i)}
              />
            ))}
            <Box h="20px"></Box>
          </VStack>
          <Box w="270px">
            <Center mt="100px" pos={'sticky'} top="200px">
              <Image src={page_sections[current_slide].image_src} alt="section image" />
            </Center>
          </Box>
        </Flex>
        <Divider
