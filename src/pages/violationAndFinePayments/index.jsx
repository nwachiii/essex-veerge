...
import {demoViolationAndFinePaymentsPageTableData} from 'constants/DEMODATA/account/accountPages';

import Head from 'next/head';
import {VIOLATION_AND_FINEPAYMENT_COLUMN} from 'constants/accounts/tables/violationAndFinePayment';

const limit = 10;
const ViolationsAndFinePayments = () => {
  ...
  const transactions =
    demoViolationAndFinePaymentsPageTableData?.[`page${currentPage}`] ??
    demoViolationAndFinePaymentsPageTableData?.[`1`];
  ...
  const columns = useMemo(() => VIOLATION_AND_FINEPAYMENT_COLUMN, []);

  return (
    <Box w="full" minH="100vh" bg="#FAFAFA" h={isSmallerLaptop ? '60vh' : ''}>
      <Head>
        <title>Essex | Violation & Fine Payments</title>
      ...
      >
        ...
        >
          ...
          <AccountOverViewHeader header="Total Amount Paid" amount="12455.67" />
          <MatadorCustomTable
            minW="full"
            forMemo={[router]}
            ...
            DATA={transactions}
            isManageAgentEmpty="No fee has been found yet"
          />
        </Box>
      </LayoutView>
    </Box>
...
export default ViolationsAndFinePayments;
