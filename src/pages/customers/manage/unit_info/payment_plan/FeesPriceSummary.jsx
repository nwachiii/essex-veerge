...
export const FeesPriceSummaryModal = ({
  data,
  checkedItems,
  mutation,
  unitInfo,
  ...
  return (
    <Popup
      ...
      color="#191919"
      position="relative"
      isOpen={FEES_UPDATE_SUMMARY.isOpen}
      onClose={FEES_UPDATE_SUMMARY.onClose}
    >
      <HStack>
        <Image
          alt="back icon"
          cursor="pointer"
          src={backIcon.src}
          onClick={() => FEES_UPDATE_SUMMARY.onClose()}
        />
            ...
            >
              ...
              <Box lineHeight="5">
                <Text fontSize={'18px'} color={'#191919'}>
                  ...
                  {equity.owner.last_name.charAt(0).toUpperCase() + equity.owner.last_name.slice(1)}
                </Text>
...
export default FeesPriceSummaryModal;
