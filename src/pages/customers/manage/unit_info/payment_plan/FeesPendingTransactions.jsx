...
import {FeesPriceSummaryModal} from './FeesPriceSummary';

export const FeesPendingTransactions = ({
  unitId,
  refetch,
  modal,
  deleteClose,
  ...
  const FEES_UPDATE_SUMMARY = useDisclosure();
  ...
  return (
    <>
            ...
            <>
              ...
              <HStack pt={6} w="full" justifyContent={'center'} position="absolute" bottom="10">
                ...
                <Button
                  textAlign={'center'}
                  onClick={
                    checkedEquities.length > 0 ? FEES_UPDATE_SUMMARY.onOpen : handleNoSelectedEquity
                  }
                  w="223px"
                  color={'#FFFFFF'}
                  bg="#4545FE"
      ...
      <FeesPriceSummaryModal
        data={checkedEquities}
        mutation={mutation}
        checkedItems={checkedItems}
        unitInfo={unitInfo}
        FEES_UPDATE_SUMMARY={FEES_UPDATE_SUMMARY}
        feesMutation={feesMutation}
...
export default FeesPendingTransactions;
