...
// import ListingInfo from './CustomerEditDisputedEquity.ListingInfo';
import {handleEmptySubmittedValues} from '/src/utils/removeEmptyObjectValues';
import PaymentPlan from '../../../create_account/CustomerListingDetails/CustomerListingDetails.PaymentPlan/PaymentPlan';
import SelectAListting from '../../../create_account/CustomerListingDetails/SelectAListting';
import SelectAUnit from '../../../create_account/CustomerListingDetails/SelectAUnit';
import {AnimatedLoader} from '../../../../../components/common/loaders';
import UploadEquityPackets from '../../../create_account/CustomerListingDetails/UploadEquityPackets';
import SelectDeeductionType, {
  SelectAllocation,
} from '../../../create_account/CustomerListingDetails/SelectDeeductionType';
...
export default function DisputedEquityDetails({subPages, setTab, handleProgress}) {
  ...
  return (
    // <Stack bg="#FAFAFA" minH="full" pb="40px">
    //   <LayoutView />
    <>
