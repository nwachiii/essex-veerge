...
import {demoTotalAssessmentPageTableData} from 'constants/DEMODATA/account/accountPages';

import Head from 'next/head';
import {TOTAL_ASSESSMENT_COLUMN} from 'constants/accounts/tables/totalAssessment';
...
const TotalAssessment = () => {
  ...
  const transactions =
    demoTotalAssessmentPageTableData?.[`page${currentPage}`] ??
    demoTotalAssessmentPageTableData?.[`1`];
  ...
  const columns = useMemo(() => TOTAL_ASSESSMENT_COLUMN, []);

  return (
    <Box w="full" minH="100vh" bg="#FAFAFA" h={isSmallerLaptop ? '60vh' : ''}>
      <Head>
        <title>Essex | Total Assessment</title>
      ...
      >
        ...
        >
          ...
          <AccountOverViewHeader header="Total Amount Paid" amount="4134.55" />
          <MatadorCustomTable
            minW="full"
            forMemo={[router]}
