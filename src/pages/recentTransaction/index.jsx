...
import {demoRecenteTransactionTableData} from 'constants/DEMODATA/account/accountPages';

import Head from 'next/head';
import {RECENT_TRANSACTION_COLUMN} from 'constants/accounts/tables/recentTransaction';
...
const RecentTransactions = () => {
  ...
  const transactions =
    demoRecenteTransactionTableData?.[`page${currentPage}`] ??
    demoRecenteTransactionTableData?.[`1`];
  ...
  const columns = useMemo(() => RECENT_TRANSACTION_COLUMN, []);

  return (
    <Box w="full" minH="100vh" bg="#FAFAFA" h={isSmallerLaptop ? '60vh' : ''}>
      <Head>
        <title>Essex | Recent Transactions</title>
