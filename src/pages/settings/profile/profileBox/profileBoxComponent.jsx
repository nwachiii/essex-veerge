...
import {Button, Input, Popup, UploadProfilePicture} from '../../../../ui-lib';
      ...
      <Grid templateColumns="repeat(10, 1fr)" gap={6}>
        ...
        <GridItem colSpan={8}>
          ...
          >
            ...
            <Text fontSize={32} fontWeight={700} textTransform="capitalize" mt="8px">
            ...
            {isRoleRestricted('input Bvn').check ? null : (
              <HStack spacing="25px" mt="13px" align="center">
                <Text fontSize={14} fontWeight="400" color={'#191919'} display={'flex'} gap={'2'}>
