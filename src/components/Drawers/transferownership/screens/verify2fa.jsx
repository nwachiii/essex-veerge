...
import {Auth2FA, updateTwoFac} from 'apis/settings';
import {OTPInput} from 'chakra-otp-input';
import React, {useState} from 'react';
import {IoArrowBackSharp} from 'react-icons/io5';

const TwoFaVerifcation = ({
  navigateBack,
  headerTextStyle,
  headerStyle,
  header,
  ...
  const requestIsLoading = isLoading || mutationForVerification.isLoading;
  const handleOtpInput = value => {
    if (value.length === 6) {
      mutationForVerification.mutate({
        code: value,
        update: true,
      });
    }
    ...
    <>
      ...
      >
        <Flex alignItems="center" gap={2}>
          ...
          <Text fontSize="20px" fontWeight={600} color="#191919" {...headerTextStyle}>
            {header}
          </Text>
        </Flex>
      </HStack>
        ...
        <Stack spacing="244.6px" w="full" align="center">
          <Stack align="center" spacing="12px">
            ...
            <Text
              ...
              color="#3D3D3D"
            >
              We have sent a 6 digit OTP code from your authenticator app. Kindly input to verify and
              continue.
            </Text>
            <OTPInput
              w="full"
