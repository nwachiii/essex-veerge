...
import {NotificationDrawer} from './PushNotification';

export const PushNotificationDrawer = ({
  handleScreen,
  ...
  return (
    ...
    >
      ...
      <NotificationDrawer isOpen={notificationDrawer.isOpen} onClose={notificationDrawer.onClose} />
    </DrawerContent>
  );
};
