...
export const InputAssignmentDetails = ({
  handleClose,
  no_of_fractions_available,
  handleScreen,
  payloadObj,
  setPayLoadObj,
  setCustomerId,
  ...
  const handleChange = event => {
    ...
    if (name === 'no_of_fraction') {
      ...
      if (Number(value) >= Number(no_of_fractions_available)) {
        value = no_of_fractions_available;
      }
    }
  ...
  console.log({isQueryEnabled, payloadObj});
      ...
      <DrawerBody pb="10px" mb="10px" sx={customScrollbarStyles} px="28px" pr="17px" mr="8px">
        <Stack spacing="28px" w="full">
          ...
          <Stack position="relative" w="full">
            ...
            >
              {no_of_fractions_available
                ? `${Number(payloadObj?.no_of_fraction)}/${no_of_fractions_available}`
                : null}
            </Text>
          </Stack>
              ...
              <Input
                ...
                value={
                  Number(payloadObj.amount || 0)
                    ? formatNumberWithCommas(payloadObj.amount, {
