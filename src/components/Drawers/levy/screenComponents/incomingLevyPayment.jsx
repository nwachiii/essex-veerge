...
import {IncomingPaymentRowComponent} from '../components/table/pastAndIncomingPaymentRowComponent';
import LevyTable from '../components/levyTable';
import PaymentFilter from '../components/paymentFilter';

const IncomingLevyPayment = ({setScreen}) => {
  let error;
  return (
    <>
      <HStack
      ...
      >
        <Flex alignItems="center" gap="10px">
          <IoArrowBackSharp
            fontSize="20px"
            cursor="pointer"
            onClick={() => setScreen('lmore options')}
          />
      ...
      <DrawerBody pt="24px" px={'20px'}>
        {false ? (
          ...
          <Stack spacing="24px" w="full">
            ...
            PastpaymentRowComponent
            <LevyTable
              Component={IncomingPaymentRowComponent}
...
export default IncomingLevyPayment;
