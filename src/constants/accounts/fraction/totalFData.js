...
// "depositorsName": "Darrell Stevard",
// "amount": "N12,000,0000.00",
// "depositDate": "5th August"

export const FRACTION_AMOUNT_COLUMN = data => [
  // {
  //   Header: 'No.',
  //   accessor: row => {
  ...
  },
  {
    Header: 'Amount',
    accessor: row => {
      return <Text>{priceString('naira', row?.amount)}</Text>;
    },
  },
];
